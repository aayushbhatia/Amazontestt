...
//open url and enter all valid details
		...
		driver.findElement(By.id("ap_email_login")).sendKeys("905");// enter partial number
		...
		driver.findElement(By.id("continue")).click(); //after click enter otp and create the account
		
		boolean am=	driver.findElement(By.className("a-alert-content")).isDisplayed(); // by this we can check the error message
